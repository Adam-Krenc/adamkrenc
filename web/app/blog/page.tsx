      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {posts.map((post) => (
            <article
              key={post.slug}
              className="group rounded-2xl overflow-hidden bg-[#0f172a] border border-[#1e2d47] hover:border-[#6B8FBF] transition-all duration-200 hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/40 flex flex-col"
            >
              ...
              <div className="flex-1 flex flex-col p-6 space-y-3">
                ...
                <div className="pt-2">
                  <Link
                    href={`/blog/${post.slug}`}
                    className="inline-flex items-center text-sm font-semibold text-[#E02020] group-hover:text-[#f97373] transition-colors"
                  >
                    Číst celý článek
